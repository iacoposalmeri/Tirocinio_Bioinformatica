...
dim_red = ['PCA', 'Aitchison_PCA', 'PCoA', 'UMAP']
...
for scenario in scenarios:
    ...
    for cutoff in cutoffs:
        ...
        for technique in dim_red:
            ...
            if technique == 'PCA' or technique == 'Aitchison_PCA':
            ...
            if technique == 'PCoA':
                ...
                X_train_final = pcoa_res.samples.iloc[:, :15].values
                X_test_final = None
            ...
            if technique == 'UMAP':
                ...
                X_train_final = umap_15d_clr.fit_transform(X_train_scaled)
