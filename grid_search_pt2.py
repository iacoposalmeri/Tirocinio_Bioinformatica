...
models = {
    ...
    'XGB': XGBClassifier(n_jobs=-1, random_state=SEED, tree_method='hist'),
    'SVM': SVC(class_weight='balanced', probability=True, random_state=SEED, cache_size=2000)
}
...
print("\nCOMPLETATO! I campioni assoluti sono stati salvati in Fase2_Vincitori_GridSearch2.csv")
