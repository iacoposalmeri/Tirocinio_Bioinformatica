...
from funzioni_crc import maschera_prevalenza, caricamento_pulizia_dati, filtraggio, trasformazione_clr, standard_scaler, crossvalidation, trasformazione_rclr_nativa
...
risultati_cv = {"cutoff": [], "Modello": [], "Media_f1_macro": [], "Deviazione_standard_f1_macro": []}
...
df_risultati_cv.to_csv("risultati_crossvalidation_no_riduzioni_rclr.csv", index=False)