...
risultati_cv = {"cutoff": [],"k_skb": [], "varianza_pca": [],  "n_componenti": [], "Modello": [], "Media_f1_macro": [], "Deviazione_standard_f1_macro": []}
...
for cutoff in cutoffs:
        ...
        for ks in k_skb:
                ...
                for varianza in varianze_pca:
                        ...
                        X_train_pca, X_test_pca, pca_fitted = pca_classica(X_train_skb, X_test_skb, n_components=varianza)
