...
report_no_riduzioni_rclr = pd.read_csv("risultati_crossvalidation_no_riduzioni_rclr.csv")
...
report_no_riduzioni_rclr.sort_values(by="Media_f1_macro", ascending=False, inplace=True)
